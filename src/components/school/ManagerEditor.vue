            ...
            <v-row class="my-3 mb-10 justify-center">
                ...
                <v-col cols="12" md="6">
                    <v-number-input v-model="quotePerStudent" v-bind="quotePerStudentProps" :reverse="false"
                        controlVariant="default" :precision=3 label="Quota per Studente" prefix="€" :hideInput="false" :inset="false"
                        :min="0">
                    </v-number-input>
                </v-col>
                <v-col cols="12" md="6">
                    <v-number-input v-model="cashFund" v-bind="cashFundProps" :reverse="false" controlVariant="default"
                        label="Fondo Cassa" :precision=3 :hideInput="false" prefix="€" :inset="false" :min="0">
                    </v-number-input>
                </v-col>
            </v-row>
        </v-card-text>
